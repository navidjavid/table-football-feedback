...
# means it crashed/rebooted/disconnected mid-match without ever reporting
# GAME_OVER, not just normal network jitter.
STALE_MATCH_SEC = _env_int("STALE_MATCH_SEC", 45)
